            ...
            <tr>
                <td valign="top" style="width: 120px;">
                    <dl class="dl-horizontal">
                        ...
                        <dt>Weight</dt>
                        <dd><c:out value="${pet.weight}"/></dd>
                        <dt>Comments</dt>
                        <dd><c:out value="${pet.comments}"/></dd>
                        <dt>Character</dt>
                        <dd><c:out value="${pet.character}"/></dd>
                    </dl>
                </td>
                <td valign="top">
                		...
                		<tr>
                		<td colspan="4">
	                	<datatables:table id="visits_${pet.name}" sort="false" data="${pet.visits}" cdn="true" row="visit" theme="bootstrap2" 
	                      cssClass="table table-condensed" paginate="false" filter="false" info="false" export="pdf">
				        ...
				        <datatables:column title="Veterinarian" property="vet.firstName"/>
				        <datatables:column title="Edit" display="HTML">
				        	<spring:url value="/owners/{ownerId}/pets/{petId}/visit/{visitId}/edit" var="visitUrl">
		                        <spring:param name="ownerId" value="${owner.id}"/>
			    	...
			    	<tr>
                		 <td> 
                            ...
                            <td>
                             ...
                             <td>
			                    <spring:url value="/owners/{ownerId}/pets/{petId}/visits/filter" var="visitUrl">
			                        <spring:param name="ownerId" value="${owner.id}"/>
			                        <spring:param name="petId" value="${pet.id}"/>
			                    </spring:url>
			                    <a href="${fn:escapeXml(visitUrl)}">Filter</a>
                            </td>
                	</tr>
			    	</table>
